...
public abstract class Hilt_ResultActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
  ...
  Hilt_ResultActivity(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ResultActivity_GeneratedInjector) this.generatedComponent()).injectResultActivity(UnsafeCasts.<ResultActivity>unsafeCast(this));
    }
  }
